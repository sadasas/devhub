  ...
  return (
    <div className="tl-root" data-zoom={zoom} style={{width:"100%", minWidth:0, contain:"inline-size"}}>
      ...
      <div className="tl-wrap" style={{display:"grid",gridTemplateColumns:`${LANE_LABEL_W}px 1fr`,gridTemplateRows:"64px 1fr",border:"1px solid var(--border-hairline)",borderRadius:"var(--radius-card)",overflow:"hidden",background:"var(--bg-elevated)",width:"100%",minWidth:0}}>
          ...
          <div ref={laneRef} style={{overflow:"hidden",overflowY:"auto",scrollbarWidth:"thin",maxHeight:"60vh",position:"sticky",left:0,zIndex:2,background:"var(--bg-elevated)",minWidth:0,overscrollBehavior:"contain"}}>
          ...
          <div ref={gridRef} style={{overflow:"auto",position:"relative",maxHeight:"60vh",minWidth:0,overscrollBehavior:"contain"}} onDragOver={handleGridDragOver} onDragLeave={(e)=>{ if(e.target===e.currentTarget) setGhostDate(null); }}>
