          ...
          action={
            canEdit && (
              <div className="api-empty-actions">
                <Button size="md" leftIcon={<Plus size={14} weight="bold" aria-hidden="true" />} onClick={onNewEndpoint}>
                  {t('api.toolbar.newEndpoint')}
                </Button>
                <Button size="sm" variant="ghost" leftIcon={<UploadSimple size={14} aria-hidden="true" />} onClick={onImport}>
