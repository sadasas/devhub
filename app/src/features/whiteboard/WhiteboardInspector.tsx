...
import type { WhiteboardBoundary, WhiteboardEdge, WhiteboardShape, WhiteboardSticky, WhiteboardText, WhiteboardElement, WhiteboardAlign } from '../../lib/types';
...
export function WhiteboardInspector({ element, selectedCount, onPatch, tool, penColor, penWidth, onPenColorChange, onPenWidthChange, eraserWidth, onEraserWidthChange, stickyColor, stickyTextColor, stickyFontSize, stickyAlign, onStickyColorChange, onStickyTextColorChange, onStickyFontSizeChange, onStickyAlignChange, textColor, textFontSize, textAlign, onTextColorChange, onTextFontSizeChange, onTextAlignChange, shapeColor, shapeLabelColor, shapeFontSize, shapeAlign, onShapeColorChange, onShapeLabelColorChange, onShapeFontSizeChange, onShapeAlignChange, edgeColor, edgeFontSize, edgeAlign, onEdgeColorChange, onEdgeFontSizeChange, onEdgeAlignChange, boundaryColor, boundaryLabelColor, boundaryFontSize, boundaryAlign, onBoundaryColorChange, onBoundaryLabelColorChange, onBoundaryFontSizeChange, onBoundaryAlignChange, refTitle, refMeta }: WhiteboardInspectorProps) {
    ...
    if (tool === 'sticky' && stickyColor !== undefined && onStickyColorChange) {
      return (
        <div className="wb-inspector" role="complementary" aria-label={t('whiteboard.tool.sticky')}>
          ...
          <label className="field"><span className="field-label">{t('whiteboard.popover.fontSize')}</span><div className="wb-font-slider"><input type="range" min={8} max={48} step={1} value={stickyFontSize ?? 12} onChange={(e) => onStickyFontSizeChange?.(Number(e.target.value))} aria-label={t('whiteboard.popover.fontSize')} /><input type="number" className="input wb-font-input" min={8} max={72} step={1} value={stickyFontSize ?? 12} onChange={(e) => { const v = Number(e.target.value); if (Number.isFinite(v)) onStickyFontSizeChange?.(Math.max(8, Math.min(72, v))); }} /></div></label>
    ...
    if (tool === 'text' && textColor !== undefined && onTextColorChange) {
      return (
        <div className="wb-inspector" role="complementary" aria-label={t('whiteboard.tool.text')}>
          ...
          <label className="field"><span className="field-label">{t('whiteboard.popover.fontSize')}</span><div className="wb-font-slider"><input type="range" min={8} max={48} step={1} value={textFontSize ?? 16} onChange={(e) => onTextFontSizeChange?.(Number(e.target.value))} aria-label={t('whiteboard.popover.fontSize')} /><input type="number" className="input wb-font-input" min={8} max={72} step={1} value={textFontSize ?? 16} onChange={(e) => { const v = Number(e.target.value); if (Number.isFinite(v)) onTextFontSizeChange?.(Math.max(8, Math.min(72, v))); }} /></div></label>
    ...
    if (tool === 'shape' && shapeColor !== undefined && onShapeColorChange) {
      return (
        <div className="wb-inspector" role="complementary" aria-label={t('whiteboard.tool.shape')}>
          ...
          <label className="field"><span className="field-label">{t('whiteboard.popover.fontSize')}</span><div className="wb-font-slider"><input type="range" min={8} max={48} step={1} value={shapeFontSize ?? 12} onChange={(e) => onShapeFontSizeChange?.(Number(e.target.value))} aria-label={t('whiteboard.popover.fontSize')} /><input type="number" className="input wb-font-input" min={8} max={72} step={1} value={shapeFontSize ?? 12} onChange={(e) => { const v = Number(e.target.value); if (Number.isFinite(v)) onShapeFontSizeChange?.(Math.max(8, Math.min(72, v))); }} /></div></label>
    ...
    if (tool === 'edge' && edgeColor !== undefined && onEdgeColorChange) {
      return (
        <div className="wb-inspector" role="complementary" aria-label={t('whiteboard.tool.edge')}>
          ...
          <label className="field"><span className="field-label">{t('whiteboard.popover.fontSize')}</span><div className="wb-font-slider"><input type="range" min={8} max={48} step={1} value={edgeFontSize ?? 11} onChange={(e) => onEdgeFontSizeChange?.(Number(e.target.value))} aria-label={t('whiteboard.popover.fontSize')} /><input type="number" className="input wb-font-input" min={8} max={72} step={1} value={edgeFontSize ?? 11} onChange={(e) => { const v = Number(e.target.value); if (Number.isFinite(v)) onEdgeFontSizeChange?.(Math.max(8, Math.min(72, v))); }} /></div></label>
    ...
    if (tool === 'boundary' && boundaryColor !== undefined && onBoundaryColorChange) {
      return (
        <div className="wb-inspector" role="complementary" aria-label={t('whiteboard.tool.boundary')}>
          ...
          <label className="field"><span className="field-label">{t('whiteboard.popover.fontSize')}</span><div className="wb-font-slider"><input type="range" min={8} max={48} step={1} value={boundaryFontSize ?? 12} onChange={(e) => onBoundaryFontSizeChange?.(Number(e.target.value))} aria-label={t('whiteboard.popover.fontSize')} /><input type="number" className="input wb-font-input" min={8} max={72} step={1} value={boundaryFontSize ?? 12} onChange={(e) => { const v = Number(e.target.value); if (Number.isFinite(v)) onBoundaryFontSizeChange?.(Math.max(8, Math.min(72, v))); }} /></div></label>
