...
const CheckEmailPageLazy = lazy(() => import('./features/auth/CheckEmailPage').then((m) => ({ default: m.CheckEmailPage })));
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route
              path="/check-email"
              element={
                <RouteBoundary fallback={<div role="status" aria-label="Loading" aria-busy="true" style={{ padding: 24 }}><span className="sr-only">Loading…</span><div aria-hidden="true" style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 400 }}><Skeleton style={{ width: 140, height: 20 }} /><Skeleton style={{ width: "100%", height: 44, borderRadius: 8 }} /></div></div>}>
                  <CheckEmailPageLazy />
                </RouteBoundary>
              }
            />
